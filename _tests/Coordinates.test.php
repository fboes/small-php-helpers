...
use fboes\SmallPhpHelpers\Coordinates;
...
class CoordinatesTest extends Tester
{
    ...
    public function testDistance()
    {
        ...
        $this->assertTrue(
            $distance > 0.45 * $coords1->getPlanetMeanRadius(),
            'Expecting distance to be a greater than 2887 km'
        );
        $this->assertTrue(
            $distance < 0.46 * $coords1->getPlanetMeanRadius(),
            'Expecting distance to be a less than 2888 km'
        );
        ...
        $this->assertTrue(
            abs($coords3->latitude - $coords2->latitude) < 0.000001,
            'Expecting latitude to be close to reference point (lat)'
        );
        $this->assertTrue(
            abs($coords3->longitude - $coords2->longitude) < 0.000001,
            'Expecting latitude to be close to reference point (lon)'
        );
    }
