...
class FormTest extends Tester
{
    public function testSimple()
    {
        ...
        $this->assertClassHasAttribute('formElements', 'fboes\SmallPhpHelpers\Form');
    }
    ...
    public function testSimpleFieldPopulation()
    {
        ...
        $this->assertRegExp(
            '#value="'.$searchValue.'"#',
            $f->returnHTML(),
            'Expecting default value to be visible in HTML for input'
        );
        ...
        $this->assertRegExp(
            '#>'.$searchValue.'<#',
            $f->returnHTML(),
            'Expecting default value to be visible in HTML for textarea'
        );
        ...
        $this->assertRegExp(
            ...
            $f->returnHTML(),
            'Expecting default value to be visible in HTML for select'
        );
        ...
        ;
        $this->assertRegExp(
            '#value="'.$searchValue.'" checked="checked"#',
            $f->returnHTML(),
            'Expecting default value to be visible in HTML for radio button'
        );
        ...
        ;
        $this->assertTrue(
            !preg_match('#value="'.$searchValue.'"#', $f->returnHTML()),
            'Expecting not matching default value not to be visible in HTML for input'
        );
        ...
        ;
        $this->assertTrue(
            !preg_match('#>'.$searchValue.'<#', $f->returnHTML()),
            'Expecting not matching default value not to be visible in HTML for textarea'
        );
        ...
        ;
        $this->assertTrue(
            !preg_match('#value="'.$searchValue.'" selected="selected"#', $f->returnHTML()),
            'Expecting not matching default value not to be visible in HTML for select'
        );
        ...
        ;
        $this->assertTrue(
            !preg_match('#value="'.$searchValue.'" checked="checked"#', $f->returnHTML()),
            'Expecting not matching default value not to be visible in HTML for radio button'
        );
    }
    ...
    public function testMultiFieldPopulation()
    {
        ...
        ;
        $this->assertTrue(
            2 == preg_match_all('#selected="selected"#', $f->returnHTML()),
            'Expecting default valuse to be visible in HTML for multi-select'
        );
        ...
        ;
        $this->assertTrue(
            2 == preg_match_all('#checked="checked"#', $f->returnHTML()),
            'Expecting default values to be visible in HTML for checkbox'
        );
        ...
        ;
        $this->assertTrue(
            !preg_match('#selected="selected"#', $f->returnHTML()),
            'Expecting not matching default values not to be visible in HTML for multi-select'
        );
        ...
        ;
        $this->assertTrue(
            !preg_match('#checked="checked"#', $f->returnHTML()),
            'Expecting not matching default values not to be visible in HTML for checkbox'
        );
    }
    ...
    public function dataValidator()
    {
        return array(
            ...
            'Required right 2' => array('<input value="0" name="required" required="required" />'),
            ...
            'Maxlength wrong' => array(
                '<input type="number" maxlength="10" value="12345678901" name="maxlength" />',
                'maxlength'
            ),
    ...
    public function testValidator($tag, $error = null)
    {
        ...
        if (!empty($error)) {
            ...
            $this->assertRegExp(
                '#class="[^"]*?invalid-'.$error.'#',
                $output,
                "Expecting 'invalid-$error' to be present in class"
            );
        } else {
            $this->assertTrue(
                !(bool)preg_match('#class=".+?invalid#', $output),
                "Expecting no 'invalid' to be present in class"
            );
        }
    }
    ...
    public function testFromAttributes($attributes)
    {
        ...
        $this->assertTrue(
            is_array($attributes),
            'Expecting attributes to be an array'
        );
        $this->assertTrue(
            !empty($f->defaultElementAttributes),
            'Expecting default attributes to be set'
        );
        $this->assertTrue(
            $attributes == $f->defaultElementAttributes,
            'Expecting default attributes to match given attributes'
        );
        ...
        foreach ($attributes[$fieldname] as $key => $value) {
            $this->assertTrue(
                strpos($output, htmlspecialchars($value)) !== false,
                "Expecting '".$value."' to be present"
            );
        }
    }
    ...
    public function testHtmlOptgroup()
    {
        ...
        $f = Form::init()
            ...
            ->select(
                '<select data-optgroup="optgroup" data-label="e" data-hint="hint" name="e" multiple="multiple">',
                $options
            )
